...
p5 = types.InlineKeyboardButton(text = "᥉᥆υᖇᥴᥱ ᖇ᥆᥆ᘔ",url="t.me/Source_Ze")
...
في قائمة المطاية اصبح مطي جديد*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == ".":
		f2 = message.from_user.first_name
		p3 = types.InlineKeyboardMarkup()
		p5 = types.InlineKeyboardButton(text = "᥉᥆υᖇᥴᥱ ᖇ᥆᥆ᘔ",url="t.me/SOURCE_ROOZ")
		p3.add(p5)
	...
	if '@' in message.text.lower():
		...
		f2 = message.from_user.first_name
		t2 = message.from_user.username
		bot.send_message(message.chat.id,"""*ممنوع ✵* [{}](t.me/{}) 
 ترسل المعرفات هنا صحبي😒*
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown")
	if 'https' in message.text.lower():
		bot.delete_message(message.chat.id, message.message_id)
		f2 = message.from_user.first_name
		t2 = message.from_user.username
		bot.send_message(message.chat.id,"""*مينفعش تبعت روابط هنا يصحبي😒 *✵ [{}](t.me/{})
**""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == "مانجا" or m == "منجتي" or m == "المبرمج":
		p3 = types.InlineKeyboardMarkup()
		e4 = types.InlineKeyboardButton(text = "ꪔᥲꪀᶢᥲ .",url="t.me/M_0_Oo")
		p3.add(e4)
		h = """[ꪔᥲꪀᶢᥲ](t.me/M_0_Oo)"""
...
نوع الحيوان : {}*""".format(f2,t2,r222,d222),disable_web_page_preview=True,parse_mode="markdown")
	if message.text == "السورس" or message.text == "سورس":
	    url = ["https://telegra.ph//file/a9a83994f60ae5a9b6e0d.jpg","https://telegra.ph//file/e43f9d328d77352e5fdf8.mp4","https://telegra.ph//file/a9a83994f60ae5a9b6e0d.jpg","https://telegra.ph//file/a9a83994f60ae5a9b6e0d.jpg"]
	    p3 = types.InlineKeyboardMarkup()
	    e3 = types.InlineKeyboardButton(text = "᥉᥆υᖇᥴᥱ ᖇ᥆᥆ᘔ .",url="t.me/SOURCE_ROOZ")
	    e4 = types.InlineKeyboardButton(text = "ꪔᥲ𝖡ᶢᥲ .",url="t.me/M_0_Oo")
	    p3.add(e3,e4)
	    r = random.choice(url)
	    h = """اهلا بك عزيزي في سورس روز
[قناة السورس .](t.me/SOURCE_ROOZ)
[مطور السورس .](t.me/M_0_Oo)"""
	...
	if message.text == "حظر" or message.text == "طرد" or message.text == "برا يڪلب":
...
⌔ اضف البوت الى مجموعتك
⌔ ارفعه ادمن مشرف
⌔ ارسل كلمة { تفعيل } ليتم تفعيل المجموعه - *[{}](t.me/{})،
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( " ᥉᥆υᖇᥴᥱ ᖇ᥆᥆ᘔ",url="t.me/SOURCE_ROOZ")
	p3.add(p5)
...
- - - -- - - - - -- - - - -
CH - @SOURCE_ROOZ*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "᥉᥆υᖇᥴᥱ ᖇ᥆᥆ᘔ",url="t.me/SOURCE_ROOZ")
	p3.add(p5)
...
- @SOURCE_ROOZ*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	if message.text == "هلو":
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
 ...
 التاريخ <<
 تاك باليوزر <<
 الرابط <<*""",parse_mode="markdown",reply_markup=p3)
